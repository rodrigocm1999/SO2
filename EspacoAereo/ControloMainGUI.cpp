...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdShow) {
	...
	if (!RegisterClassW(&window_app))
		return -1;

	CreateWindow(_T("windowClass"), _T("Controlo"), WS_OVERLAPPEDWINDOW | WS_VISIBLE, 1, 1, 1300, 1010, NULL, NULL, NULL, NULL);
	/*hWnd = CreateWindow(
		szProgName,
		TEXT("Novo Título"),
		WS_OVERLAPPEDWINDOW,
...
{
	CreateWindowW(_T("static"), _T("isto vai ser o mapa e esta feito 1000x1000 "), WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 1, 1000, 1000, hWnd,
		NULL,NULL,NULL);
	hEdit = CreateWindowW(_T("EDIT"),0, WS_VISIBLE | WS_CHILD | WS_BORDER, 1172, 10, 250, 30, hWnd,NULL, hInstanceGlobal, NULL);
	CreateWindowW(_T("Button"), _T("Add Airport"), WS_VISIBLE | WS_CHILD, 1050, 10, 120, 30, hWnd, NULL, NULL, NULL);
	CreateWindowW(_T("EDIT"), 0, WS_VISIBLE | WS_CHILD | WS_BORDER, 1050, 50, 380, 440, hWnd, NULL, hInstanceGlobal, NULL);
